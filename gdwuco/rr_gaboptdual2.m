%RR_GABOPTDUAL2 Optimization of dual gabor windows 2
%                           
...
%   tuckey (3/5) analysis window with $L_g=60$ $L=240$, $a=15$ and $M=120$,
...
%   $26$ values above $-80$~dB (relative to the maximum amplitude) on an
